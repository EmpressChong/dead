...
for (let i = 0; i < 3; i++) {
  exports.eliteFortress.GUNS.push(
    {
      POSITION: [10.5, 6, 1, 0, 0, 120 * i + 60, 0],
    },
    {
...
exports.shinySquareDummy = {
    SHAPE: 4,
    COLOR: 1,
}
exports.shinyomegasummoner = {
    PARENT: ["miniboss"],
...
exports.shinydoritoDummy = {
    SHAPE: 3,
    COLOR: 1,
}
exports.shinyomegadorito = {
    PARENT: ["sunchip"],
    SHAPE: 3,
    HITS_OWN_TYPE: "hard",
    BODY: {
...
exports.shinypentaDummy = {
    COLOR: 1,
    SHAPE: 5,
}
exports.shinyomegademonchip = {
    PARENT: ["sunchip"],
    SHAPE: 5,
    HITS_OWN_TYPE: "hard",
    BODY: {
...
exports.roguePalisade = {
    ...
    GUNS: [
        { POSITION: [4, 6, -1.6, 8, 0, 0, 0], PROPERTIES: { SHOOT_SETTINGS: combineStats([ g.factory, g.pound, ]), TYPE: ["minion", {INDEPENDENT: true}], STAT_CALCULATOR: gunCalcNames.drone, AUTOFIRE: true, MAX_CHILDREN: 3, SYNCS_SKILLS: true, WAIT_TO_CYCLE: true }},
        { POSITION: [4, 6, -1.6, 8, 0, 60, 0], PROPERTIES: { SHOOT_SETTINGS: combineStats([ g.factory, g.pound, ]), TYPE: ["minion", {INDEPENDENT: true}], STAT_CALCULATOR: gunCalcNames.drone, AUTOFIRE: true, MAX_CHILDREN: 3, SYNCS_SKILLS: true, WAIT_TO_CYCLE: true }},
        { POSITION: [4, 6, -1.6, 8, 0, 120, 0], PROPERTIES: { SHOOT_SETTINGS: combineStats([ g.factory, g.pound, ]), TYPE: ["minion", {INDEPENDENT: true}], STAT_CALCULATOR: gunCalcNames.drone, AUTOFIRE: true, MAX_CHILDREN: 3, SYNCS_SKILLS: true, WAIT_TO_CYCLE: true }},
        { POSITION: [4, 6, -1.6, 8, 0, 180, 0], PROPERTIES: { SHOOT_SETTINGS: combineStats([ g.factory, g.pound, ]), TYPE: ["minion", {INDEPENDENT: true}], STAT_CALCULATOR: gunCalcNames.drone, AUTOFIRE: true, MAX_CHILDREN: 3, SYNCS_SKILLS: true, WAIT_TO_CYCLE: true }},
        { POSITION: [4, 6, -1.6, 8, 0, 240, 0], PROPERTIES: { SHOOT_SETTINGS: combineStats([ g.factory, g.pound, ]), TYPE: ["minion", {INDEPENDENT: true}], STAT_CALCULATOR: gunCalcNames.drone, AUTOFIRE: true, MAX_CHILDREN: 3, SYNCS_SKILLS: true, WAIT_TO_CYCLE: true }},
        { POSITION: [4, 6, -1.6, 8, 0, 300, 0], PROPERTIES: { SHOOT_SETTINGS: combineStats([ g.factory, g.pound, ]), TYPE: ["minion", {INDEPENDENT: true}], STAT_CALCULATOR: gunCalcNames.drone, AUTOFIRE: true, MAX_CHILDREN: 3, SYNCS_SKILLS: true, WAIT_TO_CYCLE: true }},
    ],
    TURRETS: [
...
exports.helenortress = {
    ...
    GUNS: [
        ...
        {
            POSITION: [7, 7.5, 0.6, 7, 3, 180, 1 / 3],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.swarm]),
                TYPE: [
                    "swarm",
        ...
        {
            POSITION: [7, 7.5, 0.6, 7, 5, 300, 2 / 3],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.swarm]),
                TYPE: [
                    "swarm",
        ...
        {
            POSITION: [4, 9, 1.5, 14, 5, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.trap, g.halfrange, g.slow, g.one_third_reload, g.mega, g.halfreload, g.lessreload]),
                TYPE: "legionaryPillbox",
                STAT_CALCULATOR: gunCalcNames.trap,
            },
        },
...
exports.rogueAnni = {
    ...
    GUNS: [
        { POSITION: [4, 6, -1.6, 8, 0, 0, 0], PROPERTIES: { SHOOT_SETTINGS: combineStats([ g.pound, g.destroy, g.destroy, g.anni, g.halfrecoil, g.one_third_reload, g.halfreload, g.lessreload, g.basic ]), TYPE: ["bullet"], AUTOFIRE: true}},
        { POSITION: [4, 6, -1.6, 8, 0, 60, 0], PROPERTIES: { SHOOT_SETTINGS: combineStats([ g.pound, g.destroy, g.destroy,  g.anni, g.halfrecoil, g.one_third_reload, g.halfreload, g.lessreload, g.basic ]), TYPE: ["bullet"], AUTOFIRE: true}},
        { POSITION: [4, 6, -1.6, 8, 0, 120, 0], PROPERTIES: { SHOOT_SETTINGS: combineStats([ g.pound, g.destroy, g.destroy, g.anni, g.halfrecoil, g.one_third_reload, g.halfreload, g.lessreload, g.basic ]), TYPE: ["bullet"], AUTOFIRE: true}},
        { POSITION: [4, 6, -1.6, 8, 0, 180, 0], PROPERTIES: { SHOOT_SETTINGS: combineStats([ g.pound, g.destroy, g.destroy, g.anni, g.halfrecoil, g.one_third_reload, g.halfreload, g.lessreload, g.basic ]), TYPE: ["bullet"], AUTOFIRE: true}},
        { POSITION: [4, 6, -1.6, 8, 0, 240, 0], PROPERTIES: { SHOOT_SETTINGS: combineStats([ g.pound, g.destroy, g.destroy, g.anni, g.halfrecoil, g.one_third_reload, g.halfreload, g.lessreload, g.basic ]), TYPE: ["bullet"], AUTOFIRE: true}},
        { POSITION: [4, 6, -1.6, 8, 0, 300, 0], PROPERTIES: { SHOOT_SETTINGS: combineStats([ g.pound, g.destroy, g.destroy, g.anni, g.halfrecoil, g.one_third_reload, g.halfreload, g.lessreload, g.basic ]), TYPE: ["bullet"], AUTOFIRE: true}},
        { POSITION: [15, 7, 0.6, 0, 0, 30, 0], PROPERTIES: { TYPE: "swarm", SHOOT_SETTINGS: combineStats([g.swarm, g.battle, g.carrier]), STAT_CALCULATOR: gunCalcNames.swarm, AUTOFIRE: true, SYNCS_SKILLS: true, WAIT_TO_CYCLE: true }},
        { POSITION: [15, 7, 0.6, 0, 0, 90, 0], PROPERTIES: { TYPE: "swarm" , SHOOT_SETTINGS: combineStats([g.swarm, g.battle, g.carrier]), STAT_CALCULATOR: gunCalcNames.swarm, AUTOFIRE: true, SYNCS_SKILLS: true, WAIT_TO_CYCLE: true }},
        { POSITION: [15, 7, 0.6, 0, 0, 150, 0], PROPERTIES: { TYPE: "swarm" , SHOOT_SETTINGS: combineStats([g.swarm, g.battle, g.carrier]), STAT_CALCULATOR: gunCalcNames.swarm, AUTOFIRE: true, SYNCS_SKILLS: true, WAIT_TO_CYCLE: true }},
        { POSITION: [15, 7, 0.6, 0, 0, 210, 0], PROPERTIES: { TYPE: "swarm" , SHOOT_SETTINGS: combineStats([g.swarm, g.battle, g.carrier]), STAT_CALCULATOR: gunCalcNames.swarm, AUTOFIRE: true, SYNCS_SKILLS: true, WAIT_TO_CYCLE: true }},
        { POSITION: [15, 7, 0.6, 0, 0, 270, 0], PROPERTIES: { TYPE: "swarm" , SHOOT_SETTINGS: combineStats([g.swarm, g.battle, g.carrier]), STAT_CALCULATOR: gunCalcNames.swarm, AUTOFIRE: true, SYNCS_SKILLS: true, WAIT_TO_CYCLE: true }},
        { POSITION: [15, 7, 0.6, 0, 0, 330, 0], PROPERTIES: { TYPE: "swarm" , SHOOT_SETTINGS: combineStats([g.swarm, g.battle, g.carrier]), STAT_CALCULATOR: gunCalcNames.swarm, AUTOFIRE: true, SYNCS_SKILLS: true, WAIT_TO_CYCLE: true }},
    ],
}
...
for(let i = 0; i < 9; i++) {
    exports.warkBottomBody.TURRETS.push(
      {
          POSITION: [6.5, 9, 0, 360/9*(i+0.5), 160, 0],
...
exports.machineGunnerWarkTurret = {
    PARENT: ["genericTank"],
...
for(let i = 0; i < 7; i++) {
    exports.warkMiddleBody.TURRETS.push(
      {
          POSITION: [7, 8.5, 0, 360/7*(i+0.5), 160, 0],
...
for(let i = 0; i < 5; i++) {
    exports.warkTopBody.TURRETS.push(
        {
...
for(let i = 0; i < 12; i++) {
    exports.wawawarkrkrkwarkwark.TURRETS.push(
      {
...
for(let i = 0; i < 6; i++) {
    exports.rogueRammer.TURRETS.push(
      {

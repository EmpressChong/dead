...
const {makeAuto} = require("../facilitators");
...
exports.opautoBuilder = {
    PARENT: ["autoBuilder"],
    LABEL: "god Auto Builder",
    SKILL_CAP: Array(10).fill(31),
    SKILL: Array(10).fill(31),
    GUNS: [],
    TURRETS: [
        {
            POSITION: {
...
exports.developer.UPGRADES_TIER_0 = ["tanks", "bosses", "tools"];
    exports.tanks.UPGRADES_TIER_0 = ["basic", "healer", "specialTanks", "legacyTanks", "funTanks", "testingTanks", "superTanks"];
	exports.specialTanks.UPGRADES_TIER_0 = ["arenaCloser", "bases", "mothership"];
        ...
        exports.funTanks.UPGRADES_TIER_0 = ["florr_tank", "vanquisher", "armyOfOne", "godbasic", "maximumOverdrive", "mummifier", "auraBasic", "auraHealer", "weirdAutoBasic", "ghoster", "switcheroo", "tracker3", "godauto3", "helenasTank", "helenasWark", "moshrav"];
        exports.superTanks.UPGRADES_TIER_0 = ["helenasTank", "godauto3", "opautoBuilder", "helenortress", "helenasWark", "moshrav", "machineShot"];
        exports.testingTanks.UPGRADES_TIER_0 = ["diamondShape", "rotatedTrap", "colorMan", "miscTest", "mmaTest"];

    exports.bosses.UPGRADES_TIER_0 = ["sentries", "elites", "mysticals", "shinyomegaMysticals", "nesters", "rogues", "terrestrials", "celestials", "eternals", "devBosses", "rogueEmpressTier"];
        exports.sentries.UPGRADES_TIER_0 = ["sentrySwarm", "sentryGun", "sentryTrap", "shinySentrySwarm", "shinySentryGun", "shinySentryTrap"];
        exports.elites.UPGRADES_TIER_0 = ["eliteDestroyer", "eliteGunner", "eliteSprayer", "eliteBattleship", "eliteSpawner", "eliteTrapGuard", "eliteSpinner", "eliteSkimmer", "eliteFortress", "legionaryCrasher", "sprayerLegion"];
        exports.mysticals.UPGRADES_TIER_0 = ["sorcerer", "summoner", "enchantress", "exorcistor", "apostal", "perseus", "dardanos", "concordia", "mysticallestmystical"];
        exports.shinyomegaMysticals.UPGRADES_TIER_0 = ["shinyomegaSorcerer", "shinyomegasummoner", "shinyomegaenchantress", "shinyomegaexorcistor"];
        exports.nesters.UPGRADES_TIER_0 = ["nestKeeper", "nestWarden", "nestGuardian"];
        exports.rogues.UPGRADES_TIER_0 = ["roguePalisade", "rogueArmada", "alviss", "tyr", "fiolnir", "rogueAnni", "rogueEmpress", "rogueRammer"];
        exports.terrestrials.UPGRADES_TIER_0 = ["ares", "gersemi", "ezekiel", "eris", "selene"];
        exports.celestials.UPGRADES_TIER_0 = ["paladin", "freyja", "zaphkiel", "nyx", "theia", "celestiallycelestial"];
        exports.eternals.UPGRADES_TIER_0 = ["ragnarok", "kronos", "rogueEmpress", "wawawarkrkrkwarkwark"];
        exports.devBosses.UPGRADES_TIER_0 = ["taureonBoss", "tgsBoss", "helenortress"];
        exports.rogueEmpressTier.UPGRADES_TIER_0 = ["rogueEmpress", "rogueEmpressLowerBody", "rogueEmpressBottomBody", "rogueEmpressMiddleBody", "rogueEmpressTopBody", "rogueWarrior", "askshybridMissile", "autoSmasherDrone", "askshybridTurret", "diplomatTurret", "rogueEmpressBase", "devastatorTurret"];

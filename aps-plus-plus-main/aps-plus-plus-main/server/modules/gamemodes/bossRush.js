...
class BossRush {
    constructor() {
        this.bossChoices = [
            ...
            // shiny omega mysticals

            [ 5, "shinyomegaSorcerer"],
            [ 10, "shinyomegasummoner"],
            [ 12, "shinyomegaenchantress"],
            [ 15, "shinyomegaexorcistor"],
            ...
            [100, "kronos"],
            [100, "ragnarok"],
            [120, "wawawarkrkrkwarkwark"],
            [120, "rogueEmpress"],
        ];
        this.friendlyBossChoices = ["roguePalisade", "rogueArmada", "alviss", "tyr", "fiolnir", "rogueAnni", "rogueRammer"];
    ...
    spawnDominator(loc, team, type = false) {
        ...
        o.on('dead', () => {
            if (o.team === TEAM_ENEMIES) {
                ...
                sockets.broadcast('A sanctuary has been seized!')
            }
        });
    }
    ...
    spawnWave(waveId) {
        ...
        //spawn a friendly boss every 3 waves
        if (waveId % 3 == 2) {
